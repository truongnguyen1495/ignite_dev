...
import { setCourseLessonGuestVisibilityAction } from "../actions";
import { Button } from "@/components/ui/button";

export function ToggleCourseLessonGuestButton({
  lessonId,
  courseId,
  visibleToGuest,
}: {
    ...
    <Button
      ...
      onClick={(e) => {
        ...
        startTransition(async () => {
          await setCourseLessonGuestVisibilityAction(lessonId, courseId, !visibleToGuest);
          router.refresh();
        });
      }}
