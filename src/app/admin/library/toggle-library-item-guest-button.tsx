...
import { setLibraryItemGuestVisibilityAction } from "./actions";
import { Button } from "@/components/ui/button";

export function ToggleLibraryItemGuestButton({
  libraryItemId,
  visibleToGuest,
}: {
    ...
    <Button
      ...
      onClick={(e) => {
        ...
        startTransition(async () => {
          await setLibraryItemGuestVisibilityAction(libraryItemId, !visibleToGuest);
          router.refresh();
        });
      }}
