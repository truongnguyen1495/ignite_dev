...
import { BookOpen, CheckCircle2, GraduationCap, Lock, Package, PlayCircle } from "lucide-react";
import { requireActiveStudent } from "@/lib/access";
import { LEVEL_NAMES } from "@/lib/levels";
import { getOverviewRoadmap } from "@/lib/overview";
import type { LevelRoadmapStep } from "@/lib/level-roadmap";
...
export default async function LevelRoadmapPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-6">
      {/* Where every ladder gate lands a member who reached for a lesson,
          quiz or level above their own — see requireLevelAccess and friends
          in src/lib/access.ts. This page is the one that can explain it. */}
      {denied && <DeniedNotice>{copy.accessDenied}</DeniedNotice>}
